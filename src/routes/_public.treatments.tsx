...
export const Route = createFileRoute("/_public/treatments")({
  head: () => ({
    meta: [
      { title: "Treatments — SmileAbroad" },
      {
        name: "description",
        content:
          "Explore treatments — from implants and All-on-4 to veneers, crowns, and whitening.",
      },
    ],
  }),
...
const treatments = [
  {
    t: "Dental Implants",
    from: "€400",
    d: "Single implants with premium brands (Straumann, Nobel, Osstem).",
  },
  {
    t: "All-on-4 / All-on-6",
    from: "€3,900 / arch",
    d: "Full arch fixed rehabilitation on 4 or 6 implants.",
  },
  {
    t: "Porcelain Veneers",
    from: "€250",
    d: "Emax and Zirconia veneers for a natural aesthetic result.",
  },
  ...
  {
    t: "Full Mouth Rehabilitation",
    from: "€8,000+",
    d: "Complex multi-disciplinary cases, planned end to end.",
  },
];
      ...
      <section className="gradient-hero py-20">
        <div className="container-app max-w-3xl">
          ...
          <h1 className="mt-3 font-display text-5xl font-semibold tracking-tight">
            Every treatment, transparently priced.
          </h1>
        </div>
      </section>
            ...
            <CardContent className="p-6 flex flex-col h-full">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="text-right shrink-0">
                  ...
                  <p className="font-display font-semibold">{t.from}</p>
                </div>
              </div>
              ...
              <Button asChild size="sm" variant="outline" className="mt-4 self-start">
                <Link to="/assessment">Get estimate</Link>
              </Button>
            </CardContent>
          </Card>
        ))}
