...
export const Route = createFileRoute("/_public/how-it-works")({
  head: () => ({
    meta: [
      { title: "How it works — SmileAbroad" },
      {
        name: "description",
        content: "From your first question to your final crown — see how SmileAbroad works.",
      },
    ],
  }),
...
const steps = [
  {
    i: ClipboardCheck,
    t: "1. Complete your assessment",
    b: "Guided questions + optional photos or X-rays. Takes ~5 minutes.",
  },
  {
    i: Sparkles,
    t: "2. Preliminary roadmap",
    b: "Estimated treatment, visits, healing time & price range — instantly.",
  },
  {
    i: Building2,
    t: "3. Compare verified clinics",
    b: "Real ratings, response times & languages. Apply to one or many.",
  },
  {
    i: MessageCircle,
    t: "4. Talk to your coordinator",
    b: "A real person, in your language, guiding you through every step.",
  },
  {
    i: Plane,
    t: "5. Travel with confidence",
    b: "Hotel, transfers and appointments coordinated end to end.",
  },
  {
    i: Award,
    t: "6. Follow-up & guarantee",
    b: "Up to 10-year guarantee on implants, ongoing check-ins after.",
  },
];
