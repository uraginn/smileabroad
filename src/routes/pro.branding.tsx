  ...
  return (
    <div className="p-6 max-w-3xl">
      <PageHeader
        ...
        description="Used on shared treatment plans and Patient Views."
      />
      <Card>
        <CardContent className="p-6 space-y-4">
          ...
          <Field label="Hotel information">
            <Textarea
              rows={2}
              value={form.hotel_info}
              onChange={(e) => setForm({ ...form, hotel_info: e.target.value })}
            />
          </Field>
          <Field label="Transfer information">
            <Textarea
              ...
              onChange={(e) => setForm({ ...form, transfer_info: e.target.value })}
            />
          </Field>
