export const TREATMENTS = [
  "Dental Implants", "All-on-4", "All-on-6", "Veneers", "Crowns",
  "Bridges", "Root Canal", "Teeth Whitening", "Composite Bonding",
  "Full Mouth Rehabilitation", "Orthodontics", "Dentures",
];

export const COUNTRIES = [
  "Turkey", "Hungary", "Mexico", "Spain", "Poland", "Thailand", "Colombia", "Portugal",
];
