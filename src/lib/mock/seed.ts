...
export const seedClinics: Clinic[] = [
  {
    id: "clinic_istanbul",
    ...base(),
    name: "DTKURT Aesthetic Dentistry",
    slug: "dtkurt-aesthetic-dentistry",
    country: "Turkey",
    city: "Istanbul",
...
export const seedBranding: ClinicBranding[] = seedClinics.map((c, i) => ({
  ...
  email: `hello@${c.slug}.com`,
  website: `https://${c.slug}.com`,
  doctors: [
  ...
  hotel_info: c.hotel_included
    ? "4★ partner hotel included for the full stay."
    : "Hotel partners available at negotiated rates.",
  transfer_info: c.transfers_included
    ? "Airport & clinic transfers included."
...
export const seedUsers: User[] = [
  ...
  },
  {
    ...
    default_planner_dentist: true,
  },
  {
    id: "u_dtkurt_sevda",
    ...base(),
    email: "sevda@dtkurt.com",
    name: "Dr. Sevda Hız",
    role: "dentist",
    clinic_id: "clinic_istanbul",
    active: true,
...
export const seedPatients: Patient[] = [
  {
    ...
    ...base(),
    clinic_id: "clinic_istanbul",
    user_id: "legacy_submission_sofia",
    first_name: "Sofia",
    last_name: "Bennett",
...
export const seedLeads: Lead[] = [
  ...
  },
  {
    ...
    ...base(),
    clinic_id: "clinic_istanbul",
    patient_user_id: "p_marco",
    patient_name: "Marco Rossi",
    patient_country: "Italy",
    treatment: "6× Veneers",
    budget: "€3,000–€5,000",
    assigned_to: "u_coord",
    priority: "medium",
  ...
  },
  {
    ...
    ...base(),
    clinic_id: "clinic_istanbul",
    patient_user_id: "p_hannah",
    patient_name: "Hannah Müller",
...
export const seedTreatmentPlans: TreatmentPlan[] = [
  {
    ...
    summary: "Immediate load implants with fixed provisional bridge.",
    items: [
    ...
    currency: "EUR",
    price_items: [
      { id: "price_seed_implant", label: "Straumann Implant", quantity: 4, unit_price: 780 },
      {
        id: "price_seed_bridge",
        label: "Zirconia Bridge (12 units)",
        quantity: 1,
        unit_price: 3600,
      },
      { id: "price_seed_extraction", label: "Extraction", quantity: 1, unit_price: 80 },
      { id: "price_seed_graft", label: "Bone graft", quantity: 2, unit_price: 220 },
    ],
    hotel_total: 640,
    transfer_total: 90,
...
export const seedTasks: Task[] = [
  {
    ...
    clinic_id: "clinic_istanbul",
    lead_id: "l_1",
    title: "Call Sofia to confirm CBCT arrival",
    due_at: now(),
    assigned_to: "u_coord",
    done: false,
  },
  {
    ...
    clinic_id: "clinic_istanbul",
    lead_id: "l_3",
    title: "Send treatment plan draft to Hannah",
    assigned_to: "u_coord",
    done: false,
  },
];
...
export const seedAppointments: Appointment[] = [
  {
    ...
    clinic_id: "clinic_istanbul",
    patient_user_id: "legacy_submission_sofia",
    title: "Consultation — Sofia Bennett",
